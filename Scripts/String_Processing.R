...
#' grep returns a vector of the indices of the elements that contain a match
grep("\\?",my_string_vector)

#' use a logical grep statement
#' grepl retunrs a vector of logical values, one for each element of the argument
...
#' "[0-9]+" is a regular expression that means "any number that has more than one digit" ... I think
